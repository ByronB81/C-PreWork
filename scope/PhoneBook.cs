...
class PhoneBook
{
    ...
    static void AddContact()
    {
        ...
        Console.WriteLine("Enter a phone number for the new contact");
        string number = Console.ReadLine();
        if (phoneNumbers.ContainsKey(name))
        {
            Console.WriteLine("This is contact already exists in your phonebook. Their number is " + phoneNumbers[name]);
        }
        else
        {
